<?php
	class Conexion{
		private $usuario="u254924041_oscar";
		private $contrasena="oracle";
		private $host="sql153.main-hosting.eu";
		private $baseDatos="u254924041_vol";
		private $puerto=3306;
		private $link;
	...
	$beta=new Conexion; /* hola mundo*/
	$consulta="Select * from Usuario";
	$resultados=$beta->ejecutarConsulta($consulta);

	while ($fila=$beta->obtenerFila($resultados)) {
