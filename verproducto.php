...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="js/controlador-carrito.js"></script>
        <!-- End JS -->
        ...
        <div class="shell">
            ...
            <div id="main">
                ...
                <div id="content">
                    ...
                    <!-- Products -->
                    <form name="form-addcar" id="form-addcar" >

                    <h2>DETALLES DEL PRODUCTO: </h2>
                    <img src="css/images/<?php echo $_GET["imagen"];?>.jpg" alt="" width="150" height="150">
                    <h3>Nombre: <?php echo $_GET["nombre"];?> </h3>
                    <h3>Descripcion: <?php echo $_GET["descripcion"];?> </h3>
                    <h3>Peso(lb):<?php echo $_GET["peso"];?> </h3>
                    <h3>Ancho(cm):<?php echo $_GET["ancho"];?> </h3>
                    <h3>Largo(cm)<?php echo $_GET["largo"];?> </h3>
                    <h3>Alto(cm)<?php echo $_GET["alto"];?> </h3>
                    <h3>Color <?php echo $_GET["color"];?> </h3>

                    Cantidad a comprar: 
                    <input type="text" name="cantidad" id="cantidad"><br>

                    <input type="hidden" name="idProducto" id="idProducto" value="<?php $id = $_GET["idProducto"]; echo($id);?>">
