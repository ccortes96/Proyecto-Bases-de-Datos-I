<?php
   session_start();
    ...
    where pro.Oferta_idOferta <> 1;";

    $result = $conexion->ejecutarConsulta($sql);

    $query = 'select DISTINCT dep.descripcion from Departamento dep inner join Subdepartamento sub on dep.idDepartamento=sub.Departamento_idDepartamento';
	$result2 = $conexion->ejecutarConsulta($query);
...
<!-- Navigation -->
    ...
    <div id="main">
        ...
        <div id="content">
            ...
            <STRONG class= "price">Productos en oferta</STRONG>
            <!-- End Content Slider -->
                ...
                <div class="span6">
                    <div class="credits">
                        <p> 
                            <?php  
                            if(isset($_SESSION["status"])==true){
                            $mensaje = "Usuario: ".$_SESSION["nombre"].$_SESSION["idUsuario"].$_SESSION["idCarrito"].$_SESSION["idCuenta"];
                            echo $mensaje;
                            } ?> 
                        </p>
                    </div>
